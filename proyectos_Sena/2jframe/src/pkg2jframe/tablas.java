...
public class tablas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("tablas en java");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String fila[]={"123","juan daniel","suarez","garzon"};
        String p[]={"234","kakaroto","suarez","neiva"};
        String a[]={"345","leonardo","villanueva","whassington"};
        ta.addRow(fila);
        ta.addRow(p);
        ta.addRow(a);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel lim=(DefaultTableModel)table.getModel();
        lim.setRowCount(0);
