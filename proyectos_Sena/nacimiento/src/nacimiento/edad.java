...
public class edad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(46, 46, 46)
                .addComponent(btn, javax.swing.GroupLayout.PREFERRED_SIZE, 298, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActionPerformed
        ...
        LocalDate naci=LocalDate.parse(nac.getText(),date);
        LocalDate actual=LocalDate.now();
        
        Period periodo=Period.between(naci, actual);
        String resu=("Tienes: "+periodo.getYears()+ " Años "+ periodo.getMonths()+ " Meses  y "+ periodo.getDays() +" dias ");
        res.setText(resu);
